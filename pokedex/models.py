...
class Pokemon(models.Model):
    ...
    base_stat_hp = models.IntegerField()
    ...
    ability_1 = models.CharField(max_length=64, blank=True, null=True)
    ability_2 = models.CharField(max_length=64, blank=True, null=True)
    ability_3 = models.CharField(max_length=64, blank=True, null=True)
